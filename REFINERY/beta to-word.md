...
- Создать датасеты с открытыми данными НПЗ и энергетики России в целов
- Создание мобильного приложения и API
...
- ###### Первой задачей стал поиск информации.
- ###### Второе, на мой взгляд, самое трудно - перевод информации в машиночитаемый язык (JSON)  и её структурирование.
- ###### Написание скриптов, для упрощения работы с данной информацией (Поисковая система по базе данных проекта).
